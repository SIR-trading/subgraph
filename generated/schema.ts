...
export class FenwickNode extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FenwickNode entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type FenwickNode must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("FenwickNode", id.toString(), this);
    }
  }

  static loadInBlock(id: string): FenwickNode | null {
    return changetype<FenwickNode | null>(
      store.get_in_block("FenwickNode", id),
    );
  }

  static load(id: string): FenwickNode | null {
    return changetype<FenwickNode | null>(store.get("FenwickNode", id));
  }
...
export class VaultLockTree extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save VaultLockTree entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type VaultLockTree must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("VaultLockTree", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): VaultLockTree | null {
    return changetype<VaultLockTree | null>(
      store.get_in_block("VaultLockTree", id.toHexString()),
    );
  }

  static load(id: Bytes): VaultLockTree | null {
    return changetype<VaultLockTree | null>(
      store.get("VaultLockTree", id.toHexString()),
    );
  }
  ...
  get polLockedSupply(): BigInt {
    let value = this.get("polLockedSupply");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set polLockedSupply(value: BigInt) {
    this.set("polLockedSupply", Value.fromBigInt(value));
  }

  get maxIndex(): i32 {
    let value = this.get("maxIndex");
    if (!value || value.kind == ValueKind.NULL) {
      return 0;
    } else {
      return value.toI32();
  ...
  set maxIndex(value: i32) {
    this.set("maxIndex", Value.fromI32(value));
  }
}
...
export class UserMonthlyStats extends Entity {
  ...
  get monthStartTimestamp(): BigInt {
    let value = this.get("monthStartTimestamp");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set monthStartTimestamp(value: BigInt) {
    this.set("monthStartTimestamp", Value.fromBigInt(value));
  }

  get totalDepositedUsd(): BigDecimal {
    let value = this.get("totalDepositedUsd");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set totalDepositedUsd(value: BigDecimal) {
    this.set("totalDepositedUsd", Value.fromBigDecimal(value));
  }

  get totalWithdrawnUsd(): BigDecimal {
    let value = this.get("totalWithdrawnUsd");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set totalWithdrawnUsd(value: BigDecimal) {
    this.set("totalWithdrawnUsd", Value.fromBigDecimal(value));
  }
  ...
  get totalHoldSeconds(): BigInt {
    let value = this.get("totalHoldSeconds");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set totalHoldSeconds(value: BigInt) {
    this.set("totalHoldSeconds", Value.fromBigInt(value));
  }

  get bestTradePnlPercentage(): BigDecimal {
    let value = this.get("bestTradePnlPercentage");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set bestTradePnlPercentage(value: BigDecimal) {
    this.set("bestTradePnlPercentage", Value.fromBigDecimal(value));
  }

  get bestTradeDepositedUsd(): BigDecimal {
    let value = this.get("bestTradeDepositedUsd");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set bestTradeDepositedUsd(value: BigDecimal) {
    this.set("bestTradeDepositedUsd", Value.fromBigDecimal(value));
  }

  get bestTradeWithdrawnUsd(): BigDecimal {
    let value = this.get("bestTradeWithdrawnUsd");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set bestTradeWithdrawnUsd(value: BigDecimal) {
    this.set("bestTradeWithdrawnUsd", Value.fromBigDecimal(value));
  }

  get bestTradeVault(): Bytes | null {
    let value = this.get("bestTradeVault");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBytes();
  ...
  set bestTradeVault(value: Bytes | null) {
    if (!value) {
      this.unset("bestTradeVault");
    } else {
      this.set("bestTradeVault", Value.fromBytes(<Bytes>value));
    }
  }
...
export class Activity extends Entity {
  ...
  set vaultId(value: Bytes | null) {
    if (!value) {
      this.unset("vaultId");
    } else {
      this.set("vaultId", Value.fromBytes(<Bytes>value));
    }
  }
  ...
  set isAPE(value: boolean) {
    this.set("isAPE", Value.fromBoolean(value));
  }
...
export class ActivityCounter extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ActivityCounter entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ActivityCounter must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("ActivityCounter", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ActivityCounter | null {
    return changetype<ActivityCounter | null>(
      store.get_in_block("ActivityCounter", id.toHexString()),
    );
  }

  static load(id: Bytes): ActivityCounter | null {
    return changetype<ActivityCounter | null>(
      store.get("ActivityCounter", id.toHexString()),
    );
  }
